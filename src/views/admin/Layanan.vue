  ...
  <div class="container py-1">
    <div class="card">
      <div class="card-body">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3" v-if="!isTambah && !isEdit">
          <h5 class="fw-bold title-inria mb-5">Data Jenis Layanan</h5>
          ...
          <div class="d-flex justify-content-end align-items-center gap-2 mb-0">
            ...
            <!-- Tombol Tambah -->
            <button class="btn btn-primary" @click="showTambahForm()">+ Tambah</button>
          </div>
        </div>
        
       <!-- Form Tambah/Edit -->
      <div v-if="isTambah || isEdit" class="text-inter form-container">
        ...
        <!-- Tabel Data -->
        <div v-else class="table-container text-inter">
...
.form-container {
  padding-top: 20px;  /* Tambahkan ruang di atas form */
  padding-bottom: 20px; /* Tambahkan ruang di bawah form */
}
