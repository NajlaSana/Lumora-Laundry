    ...
    <div class="card p-4">
      ...
      <form @submit.prevent="tambahPelanggan">
        ...
        <div class="d-flex justify-content-end">
          <router-link to="/admin/datapelanggan" class="btn btn-warning me-2">Kembali</router-link>
...
export default {
  ...
  methods: {
    tambahPelanggan() {
      ...
      this.$router.push("/admin/datapelanggan"); // Langsung pindah halaman tanpa notifikasi
    }
  }
};
</script>
