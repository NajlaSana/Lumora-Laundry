    ...
    <div v-if="!showForm" class="card">
      <div class="card-body">
        <div class="d-flex justify-content-between align-items-center mb-3">
          <h5 class="fw-bold title-inria">Data Transaksi</h5>
        ...
        <table class="table table-striped font-inter">
              ...
              <td class="text-center">
                <div class="dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end shadow-sm border-0">
                    ...
                    <li>
                      <button class="dropdown-item d-flex align-items-center py-2 text-dark" @click="(transaksi)">
